...
const Resetpassword = () => {
  ...
  return (
   ...
   <label id='label' htmlFor="">Enter Old Password</label><br />
    <input id='inp' type="text" name="oldpassword"  onChange={handleinput}/><br />
    <label id='label' htmlFor="">Enter New Password</label><br />
    <input id='inp' type="text" name="newpassword"  onChange={handleinput}/><br />
    <label id='label' htmlFor="">Confirm New Password</label><br />
    <input id='inp' type="text" name="confirmnewpassword"  onChange={handleinput}/><br />
    <button id='button1' onClick={handlesubmit}>reset password</button>
    </div>
    <ToastContainer />
   </>
  )
