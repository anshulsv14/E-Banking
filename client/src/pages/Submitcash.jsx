...
console.log(customerid)
    const handlesubmit = async()=>{
        ...
        const res = await axios.post(api,{amount:amount,status:"credit",description: status == true ? description:"Add to Cash",customerid:customerid})
  ...
  return (
    <div id='bal' style={{width:"700px",margin:"auto",textAlign:"center",marginTop:"50px"}}>
      ...
      <div >
          <label id='label' className="addmoney-label">Enter Description (Optional)</label>
          <div >
